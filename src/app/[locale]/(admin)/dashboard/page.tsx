...
const summaryKeys = ['totalPersonnel', 'activePatients', 'availableBeds', 'pendingAdmissions'] as const;
...
export default function DashboardPage() {
  ...
  const {data} = useSWR('dashboard', fetchDashboardData, {
    fallbackData: {
      ...
      beds: [
        {id: 'ICU-01', status: 'Occupied', patientName: 'Somchai Jaidee', hn: 'HN-000123'},
        {id: 'ICU-02', status: 'Available', patientName: '-', hn: '-'},
        {id: 'ICU-03', status: 'Available', patientName: '-', hn: '-'},
        {id: 'ICU-04', status: 'Occupied', patientName: 'Narin K.', hn: 'HN-000456'}
      ],
              ...
              <Grid key={bed.id} item xs={12} md={6} lg={4}>
                <Card variant="outlined">
                  <CardContent>
                    ...
                    <Button variant="contained" fullWidth disabled={bed.status === 'Occupied'}>
                      {t('register')}
                    </Button>
                  </CardContent>
                </Card>
